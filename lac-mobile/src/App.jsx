...
const i18n = {
  en: {
    ...
    naginiLacSeed:"naginiLacSeed", naginiCustomText:"Custom text",
    ...
    naginiBundleId:"Bundle ID",
    naginiWarning:"Write down the place names separately from this device. GPS coordinates are NOT stored on the server.",
    naginiDone:"Done",
    naginiDelete:"Delete Bundle", naginiDeleting:"naginiDeleting",
    naginiConfirmDelete:"naginiConfirmDelete",
    ...
    naginiActivateDMS:"naginiActivateDMS", naginiActivating:"naginiActivating",
